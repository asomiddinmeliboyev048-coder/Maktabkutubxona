...
$inventoryStatement = $pdo->prepare(
    "SELECT b.id, b.title, b.author, b.cover_image, b.total_copies, b.available_copies,
            b.listing_type, c.name AS category_name,
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        <header class="admin-topbar">
            ...
            <div class="admin-profile"><span><i class="fa-solid fa-user-shield"></i></span><div><strong><?= e($user['first_name'] . ' ' . $user['last_name']) ?></strong><small>Administrator</small></div></div>
        </header>
                ...
                <section class="admin-panel h-100">
                    ...
                    <div class="table-responsive">
                        <table class="table admin-table align-middle">
                            <thead><tr><th>Kitob</th><th>Kategoriya / ega</th><th class="text-center">Mavjud</th></tr></thead>
                            <tbody>
                            <?php foreach ($inventory as $book): ?>
                                <tr>
                                    ...
                                    <td><span class="dark-badge"><?= e($book['category_name']) ?></span><small class="d-block mt-1"><?= e($book['owner_name'] ?: 'Maktab kutubxonasi') ?> · <?= e(library_feature_listing_label($book['listing_type'])) ?></small></td>
