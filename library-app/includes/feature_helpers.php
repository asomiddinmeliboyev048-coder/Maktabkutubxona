...
function library_feature_admin_nav(string $active): string
{
    $items = [
        ...
        'books' => ['admin/books.php', 'fa-book', 'Barcha kitoblar'],
    ...
    return library_feature_panel_nav($items, $active, 'Admin navigatsiyasi');
}
...
function library_feature_vendor_nav(string $active): string
{
    $items = [
        ...
        'reservations' => ['vendor/reservations.php', 'fa-calendar-check', 'Band qilishlar'],
        'issue' => ['vendor/issue-book.php', 'fa-arrow-up-right-from-square', 'Kitob berish'],
        'return' => ['vendor/return-book.php', 'fa-rotate-left', 'Kitobni qaytarish'],
    ];
    return library_feature_panel_nav($items, $active, 'Sotuvchi navigatsiyasi');
}

function library_feature_panel_nav(array $items, string $active, string $label): string
{
    $html = '<nav class="admin-nav" aria-label="' . e($label) . '">';
