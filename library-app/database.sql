...
-- The plaintext password is intentionally never stored in this SQL file.
...
CREATE TABLE books (
    ...
    ebook_file VARCHAR(255) DEFAULT NULL COMMENT 'Random server-side filename only',
    ebook_original_name VARCHAR(255) DEFAULT NULL,
    ebook_mime VARCHAR(100) DEFAULT NULL,
    ebook_size BIGINT UNSIGNED DEFAULT NULL,
    video_source ENUM('none','url','upload') NOT NULL DEFAULT 'none',
    video_url TEXT NULL,
    video_file VARCHAR(255) DEFAULT NULL COMMENT 'Random server-side filename only',
